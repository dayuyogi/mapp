...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="index2.html" class="logo">
      ...
      <span class="logo-mini"><b>SIPAR</b></span>
      <!-- logo for regular state and mobile devices -->
      <span class="logo-lg"><b>SI</b>Pariwisata Badung</span>
    </a>
        ...
        <li class="active treeview">
          ...
          <ul class="treeview-menu">
            ...
            <li><a href="/sipar/emergency"><i class="fa fa-circle-o"></i> Emergency Contact</a></li>
             <li><a href="/sipar/pengguna"><i class="fa fa-circle-o"></i> Pengguna</a></li>
          </ul>
          ...
          @else
          <ul class="treeview-menu">
            <li><a href="/sipar/wisata/laporan"><i class="fa fa-circle-o"></i> WISATA</a></li>
          </ul>
          @endif
        </li>
      </ul>
